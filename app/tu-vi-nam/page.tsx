...
export default function TuViNamPage() {
  const router = useRouter();

  const handleClick = () => {
    router.push('/create-tu-vi-nam');
  };
    ...
    <div className='bg-white w-full min-h-screen'>
      ...
      <div className='bg-white w-full p-3 md:p-4 flex flex-wrap md:flex-nowrap justify-between items-center shadow-md'>
        <div className='flex items-center space-x-3 md:space-x-5 mb-2 md:mb-0 w-full md:w-auto'>
          ...
          <h1 className='text-lg md:text-2xl text-[#343a40] font-semibold truncate'>Tử vi năm</h1>
        </div>
      ...
      <div className='bg-white w-full shadow-sm overflow-hidden border-t border-gray-100 p-4 md:p-6'>
        <div className='max-w-4xl mx-auto bg-white rounded-lg shadow-sm border border-gray-200 p-6'>
          <h2 className='text-xl font-bold text-gray-800 mb-4'>Tử vi năm</h2>
          ...
          <div className='mb-6'>
            ...
            <textarea rows={8} className='w-full border border-gray-300 rounded-md p-2 focus:ring-indigo-500 focus:border-indigo-500' placeholder='Nhập nội dung tử vi năm...'></textarea>
          </div>
