                ...
                <TableRow key={headerGroup.id}>
                  {headerGroup.headers.map(header => (
                    <TableHead
                      ...
                      style={{
                        width: header.column.id === 'tieu_de' ? '400px' : header.column.id === 'id' ? '120px' : header.column.id === 'ngay_dang' ? '150px' : header.column.id === 'active' ? '100px' : header.column.id === 'is_vip' ? '100px' : header.column.id === 'actions' ? '60px' : 'auto',
                      }}
                    >
                  ...
                  >
                    {row.getVisibleCells().map(cell => (
                      <TableCell
                        ...
                        style={{
                          width: cell.column.id === 'tieu_de' ? '400px' : cell.column.id === 'id' ? '120px' : cell.column.id === 'ngay_dang' ? '150px' : cell.column.id === 'active' ? '100px' : cell.column.id === 'is_vip' ? '100px' : cell.column.id === 'actions' ? '60px' : 'auto',
                        }}
                      >
